...
[1] 0 Dapat dilihat bahwa tidak ada data kosong didalam dataset tersebut, sehingga tidak perlu adanya langkah lebih lanjut terkait data kosong.
...
#tanpa diwarnai, akan ada warna default dari R nya
fviz_dist(distance)
```

dari gambar hasil grafik, melihat similarity dari fearture yang kita punya
...
7.size -> Jumlah Point disetiap Cluster. yang tergabung di cluster 1 adalah 30, sedangkan kluster 2 = 20
...
```
Hasilnya menunjukkan bahwa 4 adalah jumlah cluster optimal karena berada diposisi siku. TItik tengah dari siku. siku = 23456, maka titik tengah = 4
...
Dan kita dapat mengekstrak cluster dan menambah data awal kita untuk melakukan beberapa statistik deskriptif (rata-rata) di tingkat cluster
